...
export default function ISSTracker() {
  ...
  return (
    <div className="min-h-screen pt-24 pb-16 px-4 max-w-6xl mx-auto">
      ...
      {loading ? (
        <LoadingSpinner text="ACQUIRING ISS SIGNAL..." />
      ) : (
        <>
          {/* Live coords */}
          {pos && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="glass-card p-4 text-center">
                <div className="font-space text-xl font-bold text-space-cyan">
                  {pos.lat.toFixed(4)}°
                </div>
          ...
          {/* Map */}
          <div className="glass-card overflow-hidden mb-6" style={{ height: 400 }}>
          ...
          <div className="mt-4 flex items-center gap-2 text-slate-500 text-xs">
            ...
            Updates every 5 seconds via Open Notify API
          </div>
        </>
      )}
    </div>
